...
/* harmony export */   renderApplication: () => (/* reexport safe */ _angular_platform_server__WEBPACK_IMPORTED_MODULE_12__.renderApplication),
/* harmony export */   renderModule: () => (/* reexport safe */ _angular_platform_server__WEBPACK_IMPORTED_MODULE_12__.renderModule),
/* harmony export */   "ɵSERVER_CONTEXT": () => (/* reexport safe */ _angular_platform_server__WEBPACK_IMPORTED_MODULE_12__["ɵSERVER_CONTEXT"])
/* harmony export */ });
/* harmony import */ var D_ReeferSocial_tube_reefer_social_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 70734);
...
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/common */ 34228);
...
/* harmony import */ var localstorage_polyfill__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! localstorage-polyfill */ 59230);
/* harmony import */ var localstorage_polyfill__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(localstorage_polyfill__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var reflect_metadata__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! reflect-metadata */ 35408);
...
/* harmony import */ var node_fetch__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! node-fetch */ 21414);
/* harmony import */ var src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/environments/environment.prod */ 3822);
/* harmony import */ var _angular_platform_server__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @angular/platform-server */ 97014);
...
const api_url = src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_9__.environment.apiUrl;
// The Express app is exported so that it can be used by serverless Functions.
function app() {
  const server = express__WEBPACK_IMPORTED_MODULE_3__();
  const distFolder = (0,node_path__WEBPACK_IMPORTED_MODULE_5__.join)(process.cwd(), 'dist-video/tube-reefer-social/browser');
  ...
  const domino = __webpack_require__(/*! domino-ext */ 74891);
  const fs = __webpack_require__(/*! fs */ 57147);
  const path = __webpack_require__(/*! path */ 71017);
  const template = fs.readFileSync(path.join((0,node_path__WEBPACK_IMPORTED_MODULE_5__.join)(process.cwd(), 'dist-video/tube-reefer-social/browser'), 'index.html')).toString();
  ...
  server.get('*', (req, res) => {
    res.render(indexHtml, {
      ...
      var _ref = (0,D_ReeferSocial_tube_reefer_social_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (err, html) {
        if (err) {
        ...
        var seo = {
          title: 'ReeferTube',
          description: 'The Umbrella platform for All freedom based projects worldwide',
          image: 'https://video.healing.tube/assets/banner/Healing-Tube-Logo.jpg',
        ...
        if (params.indexOf('channel/') > -1) {
          ...
          const channel = yield getChannel(id);
          console.log({
            params
          }, {
            id
          ...
          const talent = {
            name: post?.title || post?.albumname || 'ReeferTube Post',
        ...
        html = html.replace(/\$OG_DESCRIPTION/g, strip_html_tags(seo.description));
        html = html.replace(/\$OG_META_DESCRIPTION/g, strip_html_tags(seo.description));
...
function getChannel(_x3) {
  return _getChannel.apply(this, arguments);
}
function _getChannel() {
  _getChannel = (0,D_ReeferSocial_tube_reefer_social_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (id) {
    return (0,node_fetch__WEBPACK_IMPORTED_MODULE_11__["default"])(api_url + 'channels/' + id).then(resp => resp.json()).catch(err => {
      console.log("getChannel: ", err);
    });
  });
  return _getChannel.apply(this, arguments);
}
function getPost(_x4) {
  return _getPost.apply(this, arguments);
}
function _getPost() {
  _getPost = (0,D_ReeferSocial_tube_reefer_social_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (id) {
    console.log(api_url);
    return (0,node_fetch__WEBPACK_IMPORTED_MODULE_11__["default"])(api_url + 'posts/get/' + id).then(resp => resp.json());
  });
  return _getPost.apply(this, arguments);
}
...
/* harmony import */ var _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @fortawesome/angular-fontawesome */ 93737);
...
/* harmony import */ var _modals_video_post_modal_video_post_modal_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../modals/video-post-modal/video-post-modal.component */ 34622);
/* harmony import */ var _modals_create_channel_create_channel_modal_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../modals/create-channel/create-channel-modal.component */ 82985);
/* harmony import */ var _modals_create_conference_link_conference_link_modal_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../modals/create-conference-link/conference-link-modal.component */ 21476);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/router */ 68804);
/* harmony import */ var _services_common_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../services/common.service */ 36978);
/* harmony import */ var _services_share_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../services/share.service */ 60910);
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../services/auth.service */ 23342);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/common */ 34228);
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @angular/forms */ 8810);
/* harmony import */ var _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @fortawesome/angular-fontawesome */ 93737);
...
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ 90337);
/* harmony import */ var _services_toast_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../services/toast.service */ 46085);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common */ 34228);
/* harmony import */ var _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @fortawesome/angular-fontawesome */ 93737);
/* harmony import */ var _tag_user_input_tag_user_input_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../tag-user-input/tag-user-input.component */ 58367);
...
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ 90337);
...
/* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/environments/environment */ 56316);
/* harmony import */ var ngx_spinner__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ngx-spinner */ 32856);
/* harmony import */ var _services_common_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../services/common.service */ 36978);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/common */ 34228);
/* harmony import */ var angular_mentions__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! angular-mentions */ 5487);
/* harmony import */ var _post_meta_data_card_post_meta_data_card_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../post-meta-data-card/post-meta-data-card.component */ 4865);
...
class TagUserInputComponent {
  constructor(renderer, spinner, commonService) {
    ...
    this.metaDataSubject.pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_4__.debounceTime)(300)).subscribe(() => {
    ...
    if (url) {
      if (!url?.includes(this.metaData?.url)) {
        ...
        this.commonService.getMetaData({
          url
        }).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_4__.takeUntil)(this.ngUnsubscribe)).subscribe({
          next: res => {
            if (res?.meta?.image) {
  ...
  static #_ = this.ɵfac = function TagUserInputComponent_Factory(t) {
    return new (t || TagUserInputComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_3__.Renderer2), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](ngx_spinner__WEBPACK_IMPORTED_MODULE_5__.NgxSpinnerService), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_services_common_service__WEBPACK_IMPORTED_MODULE_1__.CommonService));
  };
  static #_2 = this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
    ...
    viewQuery: function TagUserInputComponent_Query(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵviewQuery"](_c1, 5, _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_6__.NgbDropdown);
      }
      if (rf & 2) {
        let _t;
    ...
    dependencies: [_angular_common__WEBPACK_IMPORTED_MODULE_7__.NgIf, angular_mentions__WEBPACK_IMPORTED_MODULE_8__.MentionDirective, _post_meta_data_card_post_meta_data_card_component__WEBPACK_IMPORTED_MODULE_2__.PostMetaDataCardComponent],
...
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ 34228);
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ 90337);
/* harmony import */ var _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @fortawesome/angular-fontawesome */ 93737);
...
/* harmony import */ var _modals_video_post_modal_video_post_modal_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../modals/video-post-modal/video-post-modal.component */ 34622);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/core */ 59936);
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ 90337);
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../services/auth.service */ 23342);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/common */ 34228);
...
/* harmony import */ var _pipe_time_duration_pipe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../pipe/time-duration.pipe */ 4344);
/* harmony import */ var _pipe_date_day_pipe__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../pipe/date-day.pipe */ 56070);
...
/* harmony import */ var _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @fortawesome/angular-fontawesome */ 93737);
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ 90337);
/* harmony import */ var _pipe_time_duration_pipe__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../pipe/time-duration.pipe */ 4344);
/* harmony import */ var _pipe_date_day_pipe__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../pipe/date-day.pipe */ 56070);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 59936);
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/auth.service */ 23342);
/* harmony import */ var _services_common_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/common.service */ 36978);
...
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ 59936);
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ 90337);
/* harmony import */ var _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @fortawesome/angular-fontawesome */ 93737);
...
/* harmony import */ var _services_toast_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../services/toast.service */ 46085);
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ 90337);
/* harmony import */ var _services_channels_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../services/channels.service */ 4375);
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/auth.service */ 23342);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/common */ 34228);
/* harmony import */ var _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @fortawesome/angular-fontawesome */ 93737);
...
/* harmony import */ var _services_toast_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../services/toast.service */ 46085);
...
/* harmony import */ var _services_channels_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/channels.service */ 4375);
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/auth.service */ 23342);
/* harmony import */ var _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @fortawesome/angular-fontawesome */ 93737);
/* harmony import */ var _directives_copy_clipboard_directive__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../directives/copy-clipboard.directive */ 50564);
...
/* harmony import */ var _confirmation_modal_confirmation_modal_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../confirmation-modal/confirmation-modal.component */ 52370);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/core */ 59936);
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ 90337);
/* harmony import */ var _services_toast_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/toast.service */ 46085);
/* harmony import */ var ngx_spinner__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ngx-spinner */ 32856);
/* harmony import */ var _services_common_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/common.service */ 36978);
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../services/auth.service */ 23342);
...
/* harmony import */ var _components_tag_user_input_tag_user_input_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../components/tag-user-input/tag-user-input.component */ 58367);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 59936);
/* harmony import */ var _services_common_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/common.service */ 36978);
...
class GetImageUrlPipe {
  ...
  transform(value, defaultImageUrl) {
    ...
    return this.commonService.getImageUrl(value).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_1__.map)(blob => {
      return URL.createObjectURL(blob);
    }));
  }
  static #_ = this.ɵfac = function GetImageUrlPipe_Factory(t) {
    return new (t || GetImageUrlPipe)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_services_common_service__WEBPACK_IMPORTED_MODULE_0__.CommonService, 16));
  };
...
/* harmony export */ });
/* harmony import */ var _safe_pipe__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./safe.pipe */ 69039);
/* harmony import */ var _get_image_url_pipe__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./get-image-url.pipe */ 59096);
/* harmony import */ var _comma_seperate_pipe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./comma-seperate.pipe */ 65706);
/* harmony import */ var _time_duration_pipe__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./time-duration.pipe */ 4344);
/* harmony import */ var _date_day_pipe__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./date-day.pipe */ 56070);
/* harmony import */ var _sanitize_pipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./sanitize.pipe */ 49594);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/core */ 59936);
...
/* harmony import */ var _constant_urlConstant__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../constant/urlConstant */ 94918);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/core */ 59936);
/* harmony import */ var _common_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./common.service */ 36978);
/* harmony import */ var _toast_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./toast.service */ 46085);
/* harmony import */ var ngx_cookie_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ngx-cookie-service */ 37431);
...
/* harmony import */ var _constant_globals__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../constant/globals */ 61950);
...
class CommonService {
  ...
  static #_ = this.ɵfac = function CommonService_Factory(t) {
    return new (t || CommonService)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__.HttpClient), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_6__.Router));
  };
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/core */ 59936);
/* harmony import */ var _common_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./common.service */ 36978);
/* harmony import */ var _auth_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./auth.service */ 23342);
...
/* harmony export */ });
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @angular/common */ 34228);
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @angular/forms */ 8810);
/* harmony import */ var ngx_trim_directive__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ngx-trim-directive */ 93239);
/* harmony import */ var _directives_btn_loader_directive__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./directives/btn-loader.directive */ 97358);
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ 90337);
/* harmony import */ var _modals_confirmation_modal_confirmation_modal_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modals/confirmation-modal/confirmation-modal.component */ 52370);
/* harmony import */ var _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @fortawesome/angular-fontawesome */ 93737);
/* harmony import */ var _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! @fortawesome/free-solid-svg-icons */ 78184);
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @angular/common/http */ 56448);
/* harmony import */ var _components_video_card_video_card_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/video-card/video-card.component */ 61695);
/* harmony import */ var _components_lf_dashboard_lf_dashboard_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/lf-dashboard/lf-dashboard.component */ 3756);
/* harmony import */ var _components_channels_card_channels_card_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/channels-card/channels-card.component */ 33349);
/* harmony import */ var ngx_spinner__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ngx-spinner */ 32856);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! @angular/router */ 68804);
/* harmony import */ var _pipe_pipe_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./pipe/pipe.module */ 52132);
/* harmony import */ var _components_video_slider_list_video_slider_list_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/video-slider-list/video-slider-list.component */ 3691);
/* harmony import */ var _components_details_card_details_card_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/details-card/details-card.component */ 60502);
/* harmony import */ var _components_tag_user_input_tag_user_input_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/tag-user-input/tag-user-input.component */ 58367);
/* harmony import */ var _components_reply_comment_modal_reply_comment_modal_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/reply-comment-modal/reply-comment-modal.component */ 64127);
/* harmony import */ var ng_lazyload_image__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ng-lazyload-image */ 36296);
/* harmony import */ var _modals_video_post_modal_video_post_modal_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modals/video-post-modal/video-post-modal.component */ 34622);
/* harmony import */ var _modals_create_channel_create_channel_modal_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modals/create-channel/create-channel-modal.component */ 82985);
/* harmony import */ var _modals_create_conference_link_conference_link_modal_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modals/create-conference-link/conference-link-modal.component */ 21476);
/* harmony import */ var _directives_copy_clipboard_directive__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./directives/copy-clipboard.directive */ 50564);
/* harmony import */ var _components_post_meta_data_card_post_meta_data_card_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/post-meta-data-card/post-meta-data-card.component */ 4865);
/* harmony import */ var angular_mentions__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! angular-mentions */ 5487);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! @angular/core */ 59936);
...
const routes = [{
  path: '',
  loadChildren: () => __webpack_require__.e(/*! import() */ 984).then(__webpack_require__.bind(__webpack_require__, /*! ./main-layout/main-layout.module */ 75984)).then(m => m.MainLayoutModule)
}, {
  path: '',
  loadChildren: () => __webpack_require__.e(/*! import() */ 770).then(__webpack_require__.bind(__webpack_require__, /*! ./auth-layout/auth-layout.module */ 1770)).then(m => m.AuthLayoutModule)
}, {
  path: '**',
  redirectTo: 'home',
  pathMatch: 'full'
...
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 59936);
/* harmony import */ var _shared_services_share_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./@shared/services/share.service */ 60910);
/* harmony import */ var ngx_spinner__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ngx-spinner */ 32856);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ 68804);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/common */ 34228);
/* harmony import */ var _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @fortawesome/angular-fontawesome */ 93737);
/* harmony import */ var _shared_components_toast_modal_toast_modal_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./@shared/components/toast-modal/toast-modal.component */ 38173);
...
/* harmony import */ var _shared_components_toast_modal_toast_modal_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./@shared/components/toast-modal/toast-modal.component */ 38173);
/* harmony import */ var _shared_shared_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./@shared/shared.module */ 30359);
...
/* harmony import */ var _shared_guards_user_auth_guard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./@shared/guards/user-auth.guard */ 66341);
/* harmony import */ var ngx_cookie_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ngx-cookie-service */ 37431);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/core */ 59936);
